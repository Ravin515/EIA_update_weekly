...
eia_update = pd.read_csv("https://ir.eia.gov/wpsr/table9.csv", encoding = "cp1252")
...
eia_update = eia_update.sort_values(by = ["sub_title", "name"])
eia_update = eia_update[["sub_title", "name", "本期", "上期", "变化"]].set_index(["sub_title", "name"])
